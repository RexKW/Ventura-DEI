...
ActivityValidation.RAWCREATEMANY = zod_1.z.object({
    day_id: zod_1.z.number().nonnegative(),
    name: zod_1.z.string().min(1).max(100),
    description: zod_1.z.string(),
    type: zod_1.z.enum(["Transportation", "Entertainment", "Culinary", "Accommodation", "Others"]),
    start_time: zod_1.z.string(), // still ISO string here
    end_time: zod_1.z.string(), // still ISO string here
    cost: zod_1.z.number().nonnegative(),
    location_name: zod_1.z.string(),
    location_address: zod_1.z.string(),
    location_link: zod_1.z.string(),
    // optional second‐location fields:
    location_name2: zod_1.z.string().optional().nullable(),
    location_address2: zod_1.z.string().optional().nullable(),
    location_link2: zod_1.z.string().optional().nullable(),
